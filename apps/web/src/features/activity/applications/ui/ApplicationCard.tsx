  ...
  return (
    <div className="overflow-hidden rounded-lg bg-white">
      ...
      <div className="relative h-32 w-full overflow-hidden rounded-t-lg">
        ...
        />
        <div className="absolute inset-0 flex items-end bg-gradient-to-t from-black/50 to-black/10 p-s-20">
      ...
      <div className="flex gap-s-10 p-s-10">
        {isProgress ? (
          <>
            <button
              type="button"
              className="flex flex-1 items-center justify-center rounded-md border border-grayscale500 bg-white py-s-20"
            >
              <Text.xs className="font-medium text-grayscale500">취소하기</Text.xs>
            </button>
            <button
              type="button"
              className="flex flex-1 items-center justify-center rounded-md bg-primary700 py-s-20"
            >
          ...
          <>
            <div className="flex flex-1 items-center justify-center rounded-md bg-grayscale500 py-s-20">
              <Text.xs className="font-medium text-white">
            ...
            {isRejected && (
              <button
                type="button"
                className="flex items-center gap-s-10 px-s-10 py-s-20"
                aria-label="내역 삭제"
              >
