...
import { useAcceptCrewRequestMutation } from '../model/useAcceptCrewRequestMutation';
import { useRejectCrewRequestMutation } from '../model/useRejectCrewRequestMutation';
  ...
  return (
    <ul className="flex flex-col gap-2">
      {participants.map(({ id, requestAt, requester }) => {
        const isRowBusy =
          (acceptRequest.isPending && acceptRequest.variables === id) ||
          (rejectRequest.isPending && rejectRequest.variables === id);
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <Button
                  variant="ghost"
                  isLoading={isRowBusy}
                  onClick={() => rejectRequest.mutate(id)}
